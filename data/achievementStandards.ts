...
// 전체 과목의 성취기준 데이터베이스 (학년별 분리 버전)
export const achievementStandardsDB: { [subject: string]: Standards } = {
  "국어": {
    // [1-2학년군] 성취기준을 1학년과 2학년에 각각 할당
    "1학년": [
  ...
  "사회": {
    ...
    "5학년": [
      ...
      "[6사11-02] 경제성장이 우리 생활에 미치는 영향을 파악하고, 빠른 경제성장으로 발생한 문제의 해결방안을 탐색한다.",
  ...
  "과학": {
    "3학년": [
      ...
      "[4과07-01] 여러 가지 물체를 이용하여 소리를 내보고, 소리가 나는 물체는 떨림이 있음을 설명할 수있다.",
